...
public class Team {
    ...
    private String stadumThumbnail;
    ...
    public String getStadumThumbnail() {
        return stadumThumbnail;
    }

    public void setStadumThumbnail(String stadumThumbnail) {
        this.stadumThumbnail = stadumThumbnail;
    }
